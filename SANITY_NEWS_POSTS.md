# News Posts for Sanity Import

Copy and paste each post's information into Sanity Studio.

---

## Post 1: Discover Old D'Hanis Presented at SHA Conference

**Slug:** `sha-conference-presentation`
**Title:** Discover Old D'Hanis Presented at SHA Conference in New Orleans
**Excerpt:** We're excited to share that Discover Old D'Hanis was presented at the Society for Historical Archaeology conference in New Orleans this January.
**Author:** Michael Salton
**Date:** January 10, 2025
**Category:** Behind the Scenes
**Project:** Discover Old D'Hanis
**Featured:** Yes
**Tags:** Discover Old D'Hanis, SHA, Conference, Historical Archaeology
**Cover Image:** Upload an appropriate image

**Content:**

We're thrilled to share that Discover Old D'Hanis was presented at the Society for Historical Archaeology (SHA) conference in New Orleans this January. This was a significant milestone for our project, bringing together the worlds of historical archaeology and interactive digital experiences.

## The Presentation

Our team had the opportunity to showcase how digital technology can preserve and share archaeological sites with a wider audience. The presentation highlighted the meticulous research and collaboration that went into recreating the 1840s-1860s Alsatian settlement of D'Hanis, Texas.

## The Team

This project wouldn't have been possible without the incredible collaboration of our team:

- **Dr. Patricia Markert** - Historical research and archaeological consultation
- **Emily Grant** - Project coordination and historical documentation
- **Joyce Lee** - Content development and educational materials
- **Terry Ju** - Website development
- **Michael Salton** - Game development and 3D reconstruction

## Early Access Coming Soon

We're excited to announce that Discover Old D'Hanis will be available for early access on Steam starting February 28. This early access release will allow players to explore the settlement while we continue to refine and expand the experience based on community feedback.

## Thank You

A special thank you to the Society for Historical Archaeology for the opportunity to present at their conference. The feedback and connections made at SHA have been invaluable to the project's development.

Stay tuned for more updates as we approach the early access launch!
...
Every project begins with extensive historical research. For Discover Old D'Hanis, we worked closely with archaeologists, reviewed historical photographs, studied architectural drawings, and examined physical artifacts. This research phase is crucial - accuracy is our top priority.

## From Data to Digital

Archaeological mapping data provides the foundation for our reconstructions. We use:

- **Photogrammetry scans** of existing ruins and artifacts
- **Historical photographs** for architectural details
- **Archaeological site maps** for accurate positioning
- **Period construction techniques** to understand building methods

## The Modeling Process

Our 3D modeling workflow involves several stages:

1. **Blocking** - Creating basic shapes and proportions
2. **Detailing** - Adding architectural features and textures
3. **Material creation** - Developing historically accurate materials
4. **Lighting** - Setting up realistic lighting scenarios
5. **Optimization** - Ensuring smooth performance

## Balancing Accuracy and Playability

One of our biggest challenges is balancing historical accuracy with user experience. We want players to explore freely while maintaining historical integrity. This means:

- Accurate building layouts that are also navigable
- Realistic lighting that doesn't obscure details
...
- **Reality Capture** for photogrammetry

## Collaboration is Key

We work closely with historians, archaeologists, and community members to ensure accuracy. Their feedback helps us refine our models and catch historical inaccuracies before release.
...
Traditional historical preservation faces numerous challenges:

- **Natural decay** of buildings and artifacts
- **Environmental damage** from weather and climate change
- **Limited access** to remote or fragile sites
- **High costs** of physical restoration
- **Loss to disasters** like fires, floods, and wars

## Enter Digital Preservation

Digital technology offers new solutions:

### Accessibility

Digital reconstructions can be accessed by anyone, anywhere. Students in classrooms, researchers across the globe, and curious individuals can all explore historical sites without traveling.

### Permanence

While physical structures decay, digital copies can be preserved indefinitely. If a site is damaged or destroyed, we have a detailed record.

### Education

Interactive experiences make history engaging. Instead of reading about a settlement, students can walk through it, interact with objects, and experience daily life.

### Research Tool

Archaeologists and historians can study digital reconstructions, test theories, and make discoveries without disturbing physical sites.

## Our Approach

At Saltbox Interactive, we focus on:

1. **Community collaboration** - Working with local communities to ensure their stories are told
2. **Academic rigor** - Partnering with archaeologists and historians
3. **Open access** - Making our work available to educators and researchers
4. **Continuous improvement** - Updating reconstructions as new research emerges

## The Future

As technology advances, digital preservation will become even more powerful. Virtual reality, artificial intelligence, and improved scanning technology will allow us to create ever more detailed and accurate reconstructions.
...
The Steam Deck represents an exciting opportunity for historical education. Its portability means:

- **Classroom flexibility** - Teachers can use it for portable history lessons
- **Field trips** - Students can explore digital reconstructions while visiting physical sites
- **Personal exploration** - Learn about history anywhere, anytime

## Optimization Work

Getting Discover Old D'Hanis running smoothly on Steam Deck required several optimizations:

### Performance Improvements

- Reduced polygon counts while maintaining visual quality
- Optimized lighting and shadows for mobile GPU
- Implemented dynamic LOD (Level of Detail) system
- Improved texture streaming

### Control Mapping

We've mapped all controls to work perfectly with Steam Deck's layout:

- Analog stick movement feels natural and responsive
- Quick access menus on back buttons
- Touch screen support for UI interaction
- Gyro controls for precise camera movement (optional)

### Battery Life

We've optimized the game to provide 3-4 hours of gameplay on a full charge - perfect for a long play session or multiple classroom periods.

## User Experience

The Steam Deck's screen size (7 inches) works beautifully for exploration games. Text is readable, environmental details are clear, and the overall experience feels intimate and engaging.

## Educational Applications

The portability opens up new educational possibilities:

- **Take it to historical sites** and compare the digital reconstruction with physical ruins
- **Use in classrooms** without needing expensive computers
- **Library lending programs** could provide Steam Decks loaded with historical games
- **Museum integration** for interactive exhibits

## Availability

Discover Old D'Hanis is verified for Steam Deck and available now. Simply install from your Steam library and start exploring!
