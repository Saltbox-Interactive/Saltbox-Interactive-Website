        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 max-w-md mb-4 text-sm leading-relaxed">
              Preserving history through immersive digital experiences. Where the past meets
              cutting-edge technology.
            </p>
            <p className="text-accent/80 tracking-wider text-sm">DISCOVER. LEARN. PRESERVE.</p>
          </div>

          <div>
            <h4 className="text-foreground font-light tracking-wider mb-4 text-sm uppercase">
              Projects
            </h4>
