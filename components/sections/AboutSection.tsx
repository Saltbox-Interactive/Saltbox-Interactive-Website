...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center py-20 px-6 relative bg-gradient-to-b from-black via-gray-900/50 to-black"
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div>
              <h2
                className="text-5xl md:text-6xl font-light tracking-[0.2em] text-foreground mb-4"
            ...
            <div className="space-y-4">
              <p className="text-lg text-gray-300 leading-relaxed">
                At <span className="bg-white text-black px-1">Saltbox Interactive</span>, we believe
                the past holds invaluable lessons for the future. Through the convergence of
                historical expertise and cutting-edge technology, we create immersive digital
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {values.map((value, index) => (
              <Card
                key={index}
                className="bg-black/40 border-accent/20 hover:border-accent/40 transition-all duration-300"
              >
                <CardContent className="p-6">
                  <div className="text-3xl mb-4 opacity-60">{value.icon}</div>
                  <h3
                    className="text-xl font-light tracking-wider text-foreground mb-2"
                    style={{ fontFamily: "var(--font-bebas)" }}
                  >
                    {value.title}
                  </h3>
