...
export const metadata: Metadata = {
  ...
  description: "Learn about how Saltbox Interactive collects, uses, and protects your information. Read our privacy policy and cookie usage guidelines.",
  openGraph: {
          ...
          <div className="space-y-12 text-gray-300">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mt-4">
                At Saltbox Interactive, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg leading-relaxed mt-4">
                  This information is used solely to improve our website and user experience. You can opt out of Google Analytics tracking by declining cookies when you first visit our site.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 text-lg">
                  <li>Service providers who help us operate our website (such as Google Analytics)</li>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 text-lg">
                  <li><strong>Cookies:</strong> You can decline cookies through our cookie consent banner</li>
                  <li><strong>Newsletter:</strong> You can unsubscribe from our newsletter at any time using the link in our emails</li>
                  <li><strong>Data Access:</strong> You can request access to the personal information we hold about you</li>
