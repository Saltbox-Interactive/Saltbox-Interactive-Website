...
export default function CreditsPage() {
  ...
  const citationText = "Markert, Patricia G., Michael Salton, Emily Missetta Grant, and Joyce Lee. Discover Old D'Hanis for Windows/Mac, V. 1., Saltbox Interactive.";
    ...
    <div className="min-h-screen bg-black text-foreground py-32 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <section className="mb-16 text-center">
          <h2 className="text-3xl font-light tracking-wider text-accent mb-8" style={{ fontFamily: 'var(--font-bebas)' }}>
            PROJECT TEAM
          </h2>
